...
class _NotificationApiService implements NotificationApiService {
  _NotificationApiService(
    ...
    baseUrl ??=
        'https://palegoldenrod-ferret-920190.hostingersite.com/helper_app/';
  }
  ...
  @override
  Future<ApiResponse> saveDeviceToken(FormData body) async {
    ...
    final _options = _setStreamType<ApiResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'notifications/save_device_token.php',
  ...
  @override
  Future<int> getUnReedNotifications(FormData body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<int>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'notifications/get_un_reed_notification.php',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
